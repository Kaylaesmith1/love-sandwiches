...
def calculate_stock_data(data):
    """
    Calculate average stock data for each sandwich type and add 10%
    """
    ...
    for column in data:
        ...
        # Since we know the length will always be 5 we could do sum / 5 but if the length varies, good to use lent()
